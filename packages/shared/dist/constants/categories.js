...
exports.MARKETPLACE_FEE_RATES = exports.GST_RATES = exports.OPPORTUNITY_THRESHOLDS = exports.MARGIN_TARGETS = exports.CATEGORY_LABELS = exports.ALL_CATEGORIES = exports.EXPANSION_CATEGORIES = exports.CURRENT_CATEGORIES = void 0;
exports.CURRENT_CATEGORIES = [
    'dry_fruits',
    'nuts',
    'seeds',
    'healthy_snacks',
...
exports.MARGIN_TARGETS = {
    minGrossMargin: 40, // 40%
    minNetMargin: 20, // 20%
    targetRoi: 100, // 100%
    maxBreakEvenMonths: 6,
};
exports.OPPORTUNITY_THRESHOLDS = {
    excellent: 80,
    good: 60,
    moderate: 40,
    avoid: 0,
